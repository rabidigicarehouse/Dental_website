  ...
  return (
    <>
      <section id="section-intro" className="relative overflow-hidden" style={{ backgroundImage: 'url(/images/background/3.webp)', backgroundPosition: 'bottom', backgroundSize: 'cover' }}>
        <div className="container">
          <div className="row g-4 gx-5 align-items-center">
            <div className="col-lg-8">
              ...
              <h1 className="fs-150 fs-sm-10vw lh-1-1 wow fadeInUp" data-wow-delay=".2s">Exceptional <span className="id-color">Dental</span> Care</h1>
              <div className="col-lg-6 offset-lg-2 wow fadeInUp" data-wow-delay=".4s">
                <p className="mb-4">We offer high-quality dental care tailored for the whole family. From routine checkups to advanced treatments, our compassionate team ensures your smile stays healthy and confident.</p>
              </div>
            </div>

            <div className="col-lg-6">
              <div className="d-flex align-items-center pb-4 mb-4 c wow fadeInUp" data-wow-delay=".9s">
                <Link className="btn-main me-5 wow fadeInUp" data-wow-delay=".6s" href="/booking">Get Started Now</Link>
                <div className="d-flex align-items-center">
                  <div className="me-4">
                    <Image src="/images/testimonial/1.webp" className="w-50px circle ms-min-10" alt="" width={160} height={160} />
                    <Image src="/images/testimonial/2.webp" className="w-50px circle ms-min-10" alt="" width={160} height={160} />
                    <Image src="/images/testimonial/3.webp" className="w-50px circle ms-min-10" alt="" width={160} height={160} />
                  </div>

                  <div className="fw-600 fs-14 lh-1-5"><span className="fs-16 fw-bold">23k</span><br />happy customers</div>
                </div>
              </div>
            </div>
        ...
        <div className="container-fluid sm-hide">
          <div className="row justify-content-end">
            <div className="col-lg-5">
              <Image src="/images/misc/c2.webp" className="abs abs-middle w-40 pe-lg-5" alt="" width={1200} height={800} />
            </div>
          </div>
        </div>
