  ...
  return (
    <>
      <section className="jarallax text-light relative">
        <div className="absolute w-100 h-100 top-0 start-0 z-0" style={{ backgroundImage: 'url(/images/background/2.webp)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}></div>
        <div className="container relative z-1">
          <div className="row g-4 gx-5">
            <div className="col-lg-6">
              <div className="h-100 relative">

                <div className="subtitle wow fadeInUp" data-wow-delay=".2s">Dental Care</div>
                <h1 className="wow fadeInUp" data-wow-delay=".4s">Brighten Your Smile with Expert Dental Solutions</h1>
                ...
                <div className="abs ol-lg-12 pos-sm-relative bottom-0">
                  ...
                  <p>Experience personalized, comprehensive dental care for all ages in a warm, welcoming environment. Your healthiest, brightest smile starts here.</p>
            ...
            <div className="col-lg-6">
              <div className="relative">
                <div className="abs bottom-0 end-0 m-5">
                  <div className="p-4 mb-4 bg-color text-light rounded-1 xs-hide text-center wow fadeInUp" data-wow-delay=".0s">
                    <h1 className="fs-84 mb-1">15</h1>
                    <div className="fs-16 lh-1-5">Years of Experience</div>
                  </div>
                </div>
                <Image src="/images/misc/s5.webp" className="w-100 rounded-1" alt="" width={1200} height={800} />
              </div>
            </div>
          </div>
        </div>
